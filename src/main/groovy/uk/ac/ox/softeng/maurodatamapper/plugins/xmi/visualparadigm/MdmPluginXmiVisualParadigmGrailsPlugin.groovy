...
class MdmPluginXmiVisualParadigmGrailsPlugin extends Plugin {
    ...
    def title = "Mauro Data Mapper XMI Visual Paradigm Plugin"
    // Headline display name of the plugin
    def author = "James Welch"
    def authorEmail = "james.welch@cs.ox.ac.uk"
    def description = '''\
